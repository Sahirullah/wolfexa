...
import { finalTermReviewsData } from '../data/finalTermReviewsData';
import './StudentReviews.css';

const FinalTermReviews = () => {
  const [sortBy, setSortBy] = useState('recent');
  const [filterRating, setFilterRating] = useState('all');

  const sortedReviews = [...finalTermReviewsData].sort((a, b) => {
    if (sortBy === 'recent') {
...
export default FinalTermReviews;
